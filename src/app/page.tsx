  ...
  return (
    <div className="h-screen w-full  bg-neutral-950 relative flex flex-col items-center justify-center antialiased">
      ...
      <div className="max-w-2xl mx-auto p-4">
        ...
        <Button className="rounded-lg border border-neutral-800 focus:ring-2 focus:ring-blue-500  w-full relative z-10 mt-4  bg-neutral-950 placeholder:text-neutral-700">Join now</Button>
      </div>
      <BackgroundBeams />
    </div>
  );
