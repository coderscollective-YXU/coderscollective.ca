...
export const metadata = {
  title: "Code of Conduct - Coders Collective",
  description:
    "Coders Collective Code of Conduct - Our community standards and expectations",
};

const CodeOfConductPage = async () => {
  // Read the markdown file
  const filePath = path.join(process.cwd(), "code-of-conduct.md");
                ...
                <ul className='space-y-4'>
                  <li>
                    ...
                    >
                      ...
                      <span>Coders Collective Team</span>
                    </Link>
                  </li>
                </ul>
              </div>
